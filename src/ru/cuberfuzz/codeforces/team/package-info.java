 ...
 * Команда
 *
 * Однажды трое лучших друзей Петя, Вася и Тоня решили создать команду
 * и участвовать в соревновании по программированию.
 ...
 * (1 ≤ n ≤ 1000) — количество задач на соревновании.
 * Далее в n строках записано по три целых числа, каждое из
 * которых равно 0 или 1. Если первое число в строке равно 1,
 * то Петя уверен в решении этой задачи, в противном случае он не уверен в решении.
 * Второе число обозначает мнение Васи, а третье — мнение Тони.
 * Числа в строках разделены пробелами.
 *
 * Выходные данные
 *
 * Выведите единственное целое число — количество задач,
 * которые друзья будут реализовывать на соревновании.
 *
 * Примеры
 *
 * входные данные
 ...
 *
 * Примечание
 * В первом примере решение первой задачи знают Петя и Вася,
 * а решение второй знают все трое. Значит, они будут писать решения по этим задачам.
 * Решение третьей задачи знает только Петя, но этого недостаточно, и друзья не будут ее писать.
 *
 * Во втором примере друзья будут реализовывать только вторую задачу,
 * так как ее решение знают Вася и Тоня.
 */
